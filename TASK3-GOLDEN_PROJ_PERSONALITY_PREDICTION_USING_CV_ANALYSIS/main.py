...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
  ...
  #  result.geometry('700x550')
    ...
    Label(result, text = str('{} : {}'.format("Email:","bagmarelokesh2002@gmail.com")).title(), foreground='black', bg='white', anchor='w').pack(fill=BOTH)
    Label(result, text = str('{} : {}'.format("Mobile Number:", "7387795567")).title(), foreground='black', bg='white', anchor='w').pack(fill=BOTH)
