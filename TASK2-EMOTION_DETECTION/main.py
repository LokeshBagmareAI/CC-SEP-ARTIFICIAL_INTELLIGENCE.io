...
#adding xml sheet
face_classifier = cv2.CascadeClassifier(r'C:\Users\Lenovo\AppData\Local\Programs\Python\Python310\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml')

#adding Classifier
classifier =load_model(r'E:\CODE CLAUSE\TASK2-EMOTION_DETECTION\model.h5')

#adding emotion labels
